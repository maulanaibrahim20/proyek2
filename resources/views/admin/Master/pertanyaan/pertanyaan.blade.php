            ...
            <form method="POST" action="{{ url('/admin/Master/pertanyaan/') }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="bobot" id="bobot" placeholder="0" min="1">
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="{{ url('/admin/Master/pertanyaan/'.$item->id) }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="bobot"> Bobot </label>
                        <input type="number" class="form-control" name="bobot" id="bobot" placeholder="0" min="1" value="{{ $item->bobot }}">
                    </div>
                </div>
                <div class="modal-footer">
